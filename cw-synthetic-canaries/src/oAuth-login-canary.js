...
//  const username = secrets.QA_USER_USERNAME;
//  const password = secrets.QA_USER_PASSWORD;
//
...
//
//      await synthetics.takeScreenshot("sso-page", "loaded");
//
//      log.info('Waiting for identifier input...');
//      try {
//          await page.waitForSelector('#identifierInput', { timeout: 60000, visible: true });
...
//      await synthetics.takeScreenshot("home-page", "loaded");
//
